    ...
    <div>
        <section class="hero is-dark is-medium">
            <div class="hero-body">
                <div class="container">
                <div class="column">
                    <h1 class="title is-size-2-mobile has-text-weight-bold has-text-right-mobile">
                    ...
                    <div class="tile is-parent">
                        <div class="tile is-child box">
                            ...
                            <p>
                                ...
                                There is an excellent open source camera control library called <a href="http://gphoto.org/" target="_blank">gphoto2</a>, which appeared to have all of the functionality I needed;
...
<style lang="scss" scoped>
  .hero {
    background: url('~assets/images/pi.jpg')center center; background-size:cover;
  }
</style>